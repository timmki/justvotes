...
public final class TemplateCatalogSnapshotAdapter implements TemplateGroupSnapshotProvider {
    ...
    public TemplateCatalogSnapshotAdapter(ViewTemplateCatalog catalog) { this.catalog = catalog; }

    @Override public TemplateGroupSnapshot snapshotOf(Poll.TemplateGroupId templateGroupId) {
