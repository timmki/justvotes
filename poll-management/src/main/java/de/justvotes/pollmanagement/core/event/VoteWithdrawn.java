...
public record VoteWithdrawn(Poll.PollId pollId, Vote vote, String selection,
    ...
    public VoteWithdrawn {
        ...
        if (occurredAt == null)
            throw new IllegalArgumentException("A vote withdrawal event must identify its occurrence time.");
    }
